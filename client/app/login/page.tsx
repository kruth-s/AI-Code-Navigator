...
function LoginContent({ showPassword, setShowPassword, handleLogin }: { 
        ...
        <div className="w-full max-w-[480px] space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <form action={signInWithGoogle}>
              <button 
                type="submit"
                className="w-full flex items-center justify-center gap-2 h-12 rounded-lg border border-zinc-700 hover:bg-zinc-800/50 transition-colors text-zinc-300 hover:text-white group"
              >
            ...
            <form action={signInWithGithub}>
              <button 
                type="submit"
                className="w-full flex items-center justify-center gap-2 h-12 rounded-lg border border-zinc-700 hover:bg-zinc-800/50 transition-colors text-zinc-300 hover:text-white"
              >
